...
// SID symbols
#define SID_Right1  (* (volatile _SID *)  0xd400)
#define SID_Right2  (* (volatile _SID *)  0xd420)
#define SID_Left1   (* (volatile _SID *)  0xd440)
#define SID_Left2   (* (volatile _SID *)  0xd460)
